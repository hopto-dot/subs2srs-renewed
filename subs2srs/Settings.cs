...
namespace subs2srs
{
  ...
  public class SubSettings
  {
    ...
    private bool combineAdjacentLines;
    ...
    public bool CombineAdjacentLines
        {
        get { return combineAdjacentLines; }
        set { combineAdjacentLines = value; }
    }
  ...
  public sealed class Settings// : ISerializable 
  {
    ...
    public bool combineAdjacentLines; // added
    ...
    public void loadSettings(SaveSettings settings)
    {
      ...
      combineAdjacentLines = settings.CombineAdjacentLines;
    }
